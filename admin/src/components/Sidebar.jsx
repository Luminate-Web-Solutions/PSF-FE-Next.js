...
const Sidebar = () => {
  return (
    ...
    <>
  <nav className="fixed top-0 z-50 w-full bg-[#2e77ae] border-b border-gray-200 ">
  ...
  <aside
    id="logo-sidebar"
    className="fixed top-0 left-0 z-40 w-55 h-screen pt-20 transition-transform -translate-x-full bg-[#2e77ae] sm:translate-x-0 "
    aria-label="Sidebar"
  >
    <div className="h-full px-3 pb-4 overflow-y-auto pl-10  ">
      <ul className="space-y-2 font-medium">
        <li className='bg-[#eoeaf5]'>
          <Link
            href="/dashboard"
            className="flex items-center p-2 text-[#eoeaf5] rounded-lg  hover:bg-gray-100  group"
          >
            <svg
            ...
            {/* <span className="ms-3 text-[#eoeaf5]">Dashboard</span> */}
          </Link>
        </li>
        ...
        <li>
          ...
          >
            ...
            {/* <span className="flex-1 ms-3 whitespace-nowrap">Verticals</span> */}
        ...
        <li>
          ...
          >
            <svg
              className="shrink-0 w-5 h-5transition duration-75  group-hover:text-gray-900 "
              aria-hidden="true"
              xmlns="http://www.w3.org/2000/svg"
              fill="currentColor"
              viewBox="0 0 20 18"
